    ...
    <div className="bg-white">
      ...
      <div className="grid grid-cols-7">
        {calendarDays.map((dayData, index) => (
          <div
            key={index}
            className="relative aspect-square border-b border-r border-gray-200 p-2"
          >
            {dayData && (
              <>
                  ...
                  <div className="mt-1">
                    ...
                    >
                      <div className="flex items-center space-x-1">
                        ...
                        <div className="truncate text-xs text-blue-800">
                          {dayData.lunchBox.title}
                        </div>
                      </div>
                      
                      {/* Hover tooltip */}
                      <div className="invisible absolute left-0 top-full z-10 mt-1 w-48 rounded-lg bg-gray-900 p-2 text-xs text-white shadow-lg group-hover:visible">
                        <div className="font-semibold">{dayData.lunchBox.title}</div>
                        {dayData.lunchBox.memo && (
                          <div className="mt-1 text-gray-300">{dayData.lunchBox.memo}</div>
                        )}
